...
extension UIColor {
    ...
    struct MyTheme {
        ...
        static let eveningA = #colorLiteral(red: 0.1607843137, green: 0.1647058824, blue: 0.3960784314, alpha: 1)
        static let eveningB = #colorLiteral(red: 0.2549019608, green: 0.5803921569, blue: 0.7176470588, alpha: 1)
    }
