...
class PhotoBrowserViewController: UIViewController{
    ...
    lazy var thumbnailImageUrls: [String] = {
    ...
    lazy var highQualityImageUrls: [String] = {
        return ["http://wx1.sinaimg.cn/large/bfc243a3gy1febm7n9eorj20i60hsann.jpg",
                "http://wx3.sinaimg.cn/large/bfc243a3gy1febm7nzbz7j20ib0iek5j.jpg",
                "http://wx1.sinaimg.cn/large/bfc243a3gy1febm7orgqfj20i80ht15x.jpg",
                "http://wx2.sinaimg.cn/large/bfc243a3gy1febm7pmnk7j20i70jidwo.jpg",
    ...
    override func viewDidLoad() {
        let colCount = 3
        var rowCount = 2
        if thumbnailImageUrls.count <= 3{
            rowCount = 1
        }
        
        let xMargin: CGFloat = 30.0
        let interitemSpacing: CGFloat = 10.0
        let width: CGFloat = self.view.bounds.size.width - 60 * 2
        ...
        cv.register(PhotoBrowserCollectionViewCell.self, forCellWithReuseIdentifier: PhotoBrowserCollectionViewCell.defalutId)
...
extension PhotoBrowserViewController: PhotoBrowserDelegate {
    ...
    func photoBrowser(_ photoBrowser: PhotoBrowser, thumbnailImageForIndex index: Int) -> UIImage? {
        let cell = collectionView?.cellForItem(at: IndexPath(item: index, section: 0)) as? PhotoBrowserCollectionViewCell
        // 取thumbnailImage
