...
class ProfileManager: User, NSCoding {
    ...
    required init(unboxer: Unboxer) {
        do {
            ...
            print("get errorororrrr when init ProfileManager with unboxer....")
        }
    }
    ...
    override func setupByDictionaryFromDB(_ dictionary: [String : Any]) {
        ...
        idCardA_Url = dictionary[UserKeyInDB.idCardA_Url.rawValue] as? String ?? ""
        idCardB_Url = dictionary[UserKeyInDB.idCardB_Url.rawValue] as? String ?? ""
        passportUrl = dictionary[UserKeyInDB.passportUrl.rawValue] as? String ?? ""
